...
/** 映像・音声のサブフィールドをすべて hidden モードにリセットする */
...
/**
 * VTX から受け取った MEDIA_DEVICE_LIST_RESPONSE メッセージでメニューを初期化する
 * platform ごとのデバイスフィルタを適用してから各リスト初期化関数を呼ぶ
...
/**
 * WebRTC 接続確立後にメニューを接続中状態に切り替える
 * フォームを無効化してサブコントロールを表示する
 */
